...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#eeeeee]">
            <div className="w-[91%] max-w-[1560px] m-[0_auto] flex justify-between p-[110px_0_490px] bg-[url('/front-portfolio/images/footer_bg.png')] bg-no-repeat bg-bottom bg-contain max-md:block max-md:pb-[200px]">
                <div>
